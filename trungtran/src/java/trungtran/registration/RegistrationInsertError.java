...
public class RegistrationInsertError implements Serializable{
    ...
    private String passwordLenthErr;
    ...
    /**
     * @return the passwordLenthErr
     */
    public String getPasswordLenthErr() {
        return passwordLenthErr;
    }

    /**
     * @param passwordLenthErr the passwordLenthErr to set
     */
    public void setPasswordLenthErr(String passwordLenthErr) {
        this.passwordLenthErr = passwordLenthErr;
    }
